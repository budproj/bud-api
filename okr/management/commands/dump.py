...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        date_start, date_end, quarter = calculate_actual_cycle(
            timezone.now().month, year
        )
        ...
        TASK_1 = self.create_task(
            ...
            owner=users[1],
            support_team=[f'{users[0].first_name} {users[0].last_name}'],
        )
    ...
    def create_cycle(
        self, date_start, date_end, team, period, cadence, parent, active=True
    ):
