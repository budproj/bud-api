...
class User(AbstractBaseUser, PermissionsMixin):
    id = models.UUIDField(
        primary_key=True, default=uuid6.uuid7, null=False, blank=False
    )
    ...
    status = models.TextField(choices=UserStatusChoices.choices)
...
class UserSetting(BaseModel):
    key = models.TextField(choices=UserSettingsKeyChoices.choices)
